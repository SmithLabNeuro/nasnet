function [slabel,spikes,net_labels] = runNASNetMiSO(filenameOrNev,gamma,varargin)
%
...
% p.addOptional('netFolder','C:/Users/smithlab/spikesort/nasnet/networks',@ischar);
p.addOptional('netFolder','C:/Users/smithlab/nasnet/networks',@ischar);
